#python qlearning_mainloop.py --env-interface=custom_cart --state-len-max=2 --replay-start-size=0 --train-fe-iterations=0 --train-fe-numfactors=32 --train-fe-nummap=32 --use-conv-after-fe=1 --ep-greedy-speed=fast --train-fe-w=8 --train-fe-s=4
import gym
import numpy as np
